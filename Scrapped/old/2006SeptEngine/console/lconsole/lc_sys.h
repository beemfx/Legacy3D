...
CVar* CVar_Register(HCVARLIST hList, char* szName, char* szValue, unsigned long dwFlags);
int CVar_Set(HCVARLIST hList, char* szName, char* szValue);
int CVar_SetValue(HCVARLIST hList, char* szName, float fValue);
char* CVar_Get(HCVARLIST hList, char* szName, char* szOutput);
float CVar_GetValue(HCVARLIST hList, char* szName, int* bGotValue);
CVar* CVar_GetCVar(HCVARLIST hList, char* szName);
CVar* CVar_GetFirstCVar(HCVARLIST hList);
int CVar_AddDef(HCVARLIST hList, char* szDef, float fValue);
float CVar_GetDef(HCVARLIST hList, char* szDef, int* bGotDef);

typedef void* (*LPCVAR_CREATELIST)(void*);
typedef int (*LPCVAR_DELETELIST)(HCVARLIST);
typedef int (*LPCVAR_SET)(HCVARLIST, char*, char*);
typedef int (*LPCVAR_SETVALUE)(HCVARLIST, char*, float);
typedef char* (*LPCVAR_GET)(HCVARLIST, char*, char*);
typedef float (*LPCVAR_GETVALUE)(HCVARLIST, char*, int*);
typedef CVar* (*LPCVAR_GETCVAR)(HCVARLIST, char*);
typedef CVar* (*LPCVAR_GETFIRSTCVAR)(HCVARLIST);
typedef int (*LPCVAR_ADDDEF)(HCVARLIST, char*, float);
typedef float (*LPCVAR_GETDEF)(HCVARLIST, char*, int*);
