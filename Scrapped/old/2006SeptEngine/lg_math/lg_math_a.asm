;lg_math_a.asm - 3D math routines for the Legacy 3D Engine.
...
;L_dword __cdecl L_nextpow2(L_dword n)
;
...
global _L_nextpow2_ASM_P2;
_L_nextpow2_ASM_P2: ;Function is __cdecl
...
;L_pow2()
;
;Prototype: L_dword __cdecl L_pow2(L_byte n);
